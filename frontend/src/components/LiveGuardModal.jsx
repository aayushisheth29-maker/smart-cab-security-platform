        ...
        <div className="p-6 overflow-y-auto max-h-[80vh]">
          ...
          <div className="space-y-3">
            ...
            {shareableLocationLink && (() => {
              ...
              const emailLink = `mailto:?subject=${encodeURIComponent("My SmartCab ride — live tracking")}&body=${encodeURIComponent(shareText)}`;
              const tgLink = `https://t.me/share/url?url=${encodeURIComponent(shareableLocationLink)}&text=${encodeURIComponent("🚖 Track my SmartCab ride live")}`;
              return (
                <div className="bg-blue-50 border-2 border-blue-500 rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
                    ...
                    <button onClick={async () => {
                      if (navigator.share) {
                        try {
                          await navigator.share({ title: 'SmartCab Live Tracking', text: shareText, url: shareableLocationLink });
                        } catch (e) { /* cancelled */ }
                      } else {
