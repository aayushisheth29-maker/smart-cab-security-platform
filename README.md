...
See: [UI Design](./UI_Design.md)

## Home Page
See: [Home Page](./Home_Page.md)

## User Registration Page
See: [User Registration](./User_Registration.md)
...
## User Dashboard
See: [User Dashboard](./User_Dashboard.md)

## Admin Dashboard
See: [Admin Dashboard](./Admin_Dashboard.md)

## Frontend-Backend Integration
See: [Frontend Backend Integration](./Frontend_Backend_Integration.md)
